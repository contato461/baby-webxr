module.exports=[745865,919719,414242,836839,899715,42965,909549,633288,590064,486589,11474,436141,a=>{"use strict";var b=a.i(625562);a.i(604045);let c="pbrFragmentExtraDeclaration",d=`varying vPositionW: vec3f;
#if DEBUGMODE>0
...
#endif
`;b.ShaderStore.IncludesShadersStoreWGSL[c]||(b.ShaderStore.IncludesShadersStoreWGSL[c]=d),a.s([],745865);let e="subSurfaceScatteringFunctions",f=`fn testLightingForSSS(diffusionProfile: f32)->bool
{return diffusionProfile<1.;}`;b.ShaderStore.IncludesShadersStoreWGSL[e]||(b.ShaderStore.IncludesShadersStoreWGSL[e]=f),a.s([],919719);let g="pbrHelperFunctions",h=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;b.ShaderStore.IncludesShadersStoreWGSL[g]||(b.ShaderStore.IncludesShadersStoreWGSL[g]=h),a.s([],414242),a.i(2524);let i="pbrDirectLightingSetupFunctions",j=`struct preLightingInfo
{lightOffset: vec3f,
...
#endif
`;b.ShaderStore.IncludesShadersStoreWGSL[i]||(b.ShaderStore.IncludesShadersStoreWGSL[i]=j),a.s([],836839);let k="pbrDirectLightingFalloffFunctions",l=`fn computeDistanceLightFalloff_Standard(lightOffset: vec3f,range: f32)->f32
...
#endif
}`;b.ShaderStore.IncludesShadersStoreWGSL[k]||(b.ShaderStore.IncludesShadersStoreWGSL[k]=l),a.s([],899715),a.i(680354);let m="pbrBlockReflectance0",n=`var reflectanceF0: f32=reflectivityOut.reflectanceF0;var specularEnvironmentR0: vec3f=reflectivityOut.colorReflectanceF0;var specularEnvironmentR90: vec3f= reflectivityOut.reflectanceF90;
#ifdef ALPHAFRESNEL
...
return result;}
#endif
`;b.ShaderStore.IncludesShadersStoreWGSL[o]||(b.ShaderStore.IncludesShadersStoreWGSL[o]=p),a.s([],909549);let q="pbrIBLFunctions",r=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;b.ShaderStore.IncludesShadersStoreWGSL[q]||(b.ShaderStore.IncludesShadersStoreWGSL[q]=r),a.s([],633288);let s="pbrBlockNormalGeometric",t=`var viewDirectionW: vec3f=normalize(scene.vEyePosition.xyz-input.vPositionW);
#ifdef NORMAL
...
#endif
`;b.ShaderStore.IncludesShadersStoreWGSL[s]||(b.ShaderStore.IncludesShadersStoreWGSL[s]=t),a.s([],590064);let u="pbrBlockImageProcessing",v=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;b.ShaderStore.IncludesShadersStoreWGSL[u]||(b.ShaderStore.IncludesShadersStoreWGSL[u]=v),a.s([],486589);let w="pbrBlockPrePass",x=`#if SCENE_MRT_COUNT>0
...
#endif
`;b.ShaderStore.IncludesShadersStoreWGSL[y]||(b.ShaderStore.IncludesShadersStoreWGSL[y]=z),a.s([],436141)}];
