module.exports=[663009,a=>{"use strict";var b=a.i(625562);a.i(115747),a.i(589762),a.i(857890),a.i(745865),a.i(830981),a.i(845386);let c="openpbrFragmentSamplersDeclaration",d=`#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
#endif
`;b.ShaderStore.IncludesShadersStoreWGSL[c]||(b.ShaderStore.IncludesShadersStoreWGSL[c]=d),a.i(196025),a.i(435),a.i(160815),a.i(842357),a.i(463068),a.i(919719),a.i(136983),a.i(414242),a.i(850492),a.i(36816),a.i(254147),a.i(836839),a.i(899715),a.i(51308),a.i(227387),a.i(909549),a.i(633288);let e="openpbrNormalMapFragmentMainFunctions",f=`#if defined(GEOMETRY_NORMAL) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
#endif
`;b.ShaderStore.IncludesShadersStoreWGSL[g]||(b.ShaderStore.IncludesShadersStoreWGSL[g]=h),a.i(630447);let i="openpbrDielectricReflectance",j=`struct ReflectanceParams
{F0: f32,
F90: f32,
coloredF0: vec3f,
coloredF90: vec3f,};
...
#endif
outParams.F0=1.0f;outParams.F90=1.0f;return outParams;}`;b.ShaderStore.IncludesShadersStoreWGSL[k]||(b.ShaderStore.IncludesShadersStoreWGSL[k]=l);let m="openpbrBlockAmbientOcclusion",n=`struct ambientOcclusionOutParams
...
#endif
`;b.ShaderStore.IncludesShadersStoreWGSL[q]||(b.ShaderStore.IncludesShadersStoreWGSL[q]=r),a.i(197011),a.i(590064);let s="openpbrNormalMapFragment",t=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
#endif
`;b.ShaderStore.IncludesShadersStoreWGSL[u]||(b.ShaderStore.IncludesShadersStoreWGSL[u]=v);let w="openpbrBaseLayerData",x=`var base_color=vec3f(0.8);var base_metalness: f32=0.0;var base_diffuse_roughness: f32=0.0;var specular_weight: f32=1.0;var specular_roughness: f32=0.3;var specular_color: vec3f=vec3f(1.0);var specular_roughness_anisotropy: f32=0.0;var specular_ior: f32=1.5;var alpha: f32=1.0;var geometry_tangent: vec2f=vec2f(1.0,0.0);
#ifdef BASE_WEIGHT
...
#endif
`;b.ShaderStore.IncludesShadersStoreWGSL[w]||(b.ShaderStore.IncludesShadersStoreWGSL[w]=x);let y="openpbrCoatLayerData",z=`var coat_weight: f32=0.0f;var coat_color: vec3f=vec3f(1.0f);var coat_roughness: f32=0.0f;var coat_roughness_anisotropy: f32=0.0f;var coat_ior: f32=1.6f;var coat_darkening: f32=1.0f;var geometry_coat_tangent: vec2f=vec2f(1.0f,0.0f);
#ifdef COAT_WEIGHT
...
#endif
`;b.ShaderStore.IncludesShadersStoreWGSL[y]||(b.ShaderStore.IncludesShadersStoreWGSL[y]=z);let A="openpbrThinFilmLayerData",B=`#ifdef THIN_FILM
...
#endif
#endif
`;b.ShaderStore.IncludesShadersStoreWGSL[A]||(b.ShaderStore.IncludesShadersStoreWGSL[A]=B);let C="openpbrFuzzLayerData",D=`var fuzz_weight: f32=0.0f;var fuzz_color: vec3f=vec3f(1.0);var fuzz_roughness: f32=0.0f;
#ifdef FUZZ
#ifdef FUZZ_WEIGHT
...
#endif
#endif
`;b.ShaderStore.IncludesShadersStoreWGSL[C]||(b.ShaderStore.IncludesShadersStoreWGSL[C]=D),a.i(670124);let E="openpbrEnvironmentLighting",F=`#ifdef REFLECTION
#ifdef FUZZ
...
#endif
#endif
`;b.ShaderStore.IncludesShadersStoreWGSL[E]||(b.ShaderStore.IncludesShadersStoreWGSL[E]=F);let G="openpbrDirectLightingInit",H=`#ifdef LIGHT{X}
...
#endif
#endif
`;b.ShaderStore.IncludesShadersStoreWGSL[G]||(b.ShaderStore.IncludesShadersStoreWGSL[G]=H);let I="openpbrDirectLighting",J=`#ifdef LIGHT{X}
...
#endif
`;b.ShaderStore.IncludesShadersStoreWGSL[I]||(b.ShaderStore.IncludesShadersStoreWGSL[I]=J),a.i(410897),a.i(316972),a.i(486589),a.i(11474),a.i(852591),a.i(436141);let K="openpbrPixelShader",L=`#define OPENPBR_FRAGMENT_SHADER
...
`;b.ShaderStore.ShadersStoreWGSL[K]||(b.ShaderStore.ShadersStoreWGSL[K]=L),a.s(["openpbrPixelShaderWGSL",0,{name:K,shader:L}],663009)}];
