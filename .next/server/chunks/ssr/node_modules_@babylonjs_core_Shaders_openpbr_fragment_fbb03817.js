...
`;b.ShaderStore.IncludesShadersStore[c]||(b.ShaderStore.IncludesShadersStore[c]=d),a.i(130162),a.i(70259),a.i(10886),a.i(711866),a.i(964780);let e="openpbrFragmentSamplersDeclaration",f=`#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
#endif
`;b.ShaderStore.IncludesShadersStore[e]||(b.ShaderStore.IncludesShadersStore[e]=f),a.i(160721),a.i(681682),a.i(544248),a.i(972930),a.i(964653),a.i(129657),a.i(673268),a.i(239820),a.i(645308),a.i(754186),a.i(570599),a.i(450312),a.i(301237),a.i(533676),a.i(254999),a.i(881943),a.i(976729);let g="openpbrNormalMapFragmentMainFunctions",h=`#if defined(GEOMETRY_NORMAL) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
#endif
`;b.ShaderStore.IncludesShadersStore[g]||(b.ShaderStore.IncludesShadersStore[g]=h);let i="openpbrNormalMapFragmentFunctions",j=`#if defined(GEOMETRY_NORMAL)
...
#endif
`;b.ShaderStore.IncludesShadersStore[i]||(b.ShaderStore.IncludesShadersStore[i]=j),a.i(820271);let k="openpbrDielectricReflectance",l=`struct ReflectanceParams
...
`;b.ShaderStore.IncludesShadersStore[k]||(b.ShaderStore.IncludesShadersStore[k]=l);let m="openpbrConductorReflectance",n=`#define pbr_inline
...
#endif
outParams.F0=1.0;outParams.F90=1.0;return outParams;}`;b.ShaderStore.IncludesShadersStore[m]||(b.ShaderStore.IncludesShadersStore[m]=n);let o="openpbrBlockAmbientOcclusion",p=`struct ambientOcclusionOutParams
...
`;b.ShaderStore.IncludesShadersStore[o]||(b.ShaderStore.IncludesShadersStore[o]=p);let q="openpbrGeometryInfo",r=`struct geometryInfoOutParams
...
{geometryInfoOutParams geoInfo=geometryInfo(normalW,viewDirectionW,roughness,geometricNormalW);geometryInfoAnisoOutParams outParams;outParams.NdotV=geoInfo.NdotV;outParams.NdotVUnclamped=geoInfo.NdotVUnclamped;outParams.environmentBrdf=geoInfo.environmentBrdf;outParams.horizonOcclusion=geoInfo.horizonOcclusion;outParams.anisotropy=vAnisotropy.b;vec3 anisotropyDirection=vec3(vAnisotropy.xy,0.);mat3 anisoTBN=mat3(normalize(TBN[0]),normalize(TBN[1]),normalize(TBN[2]));outParams.anisotropicTangent=normalize(anisoTBN*anisotropyDirection);outParams.anisotropicBitangent=normalize(cross(anisoTBN[2],outParams.anisotropicTangent));outParams.TBN=TBN;return outParams;}`;b.ShaderStore.IncludesShadersStore[q]||(b.ShaderStore.IncludesShadersStore[q]=r);let s="openpbrIblFunctions",t=`#ifdef REFLECTION
...
#endif
`;b.ShaderStore.IncludesShadersStore[s]||(b.ShaderStore.IncludesShadersStore[s]=t),a.i(874402),a.i(60213);let u="openpbrNormalMapFragment",v=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;b.ShaderStore.IncludesShadersStore[u]||(b.ShaderStore.IncludesShadersStore[u]=v);let w="openpbrBlockNormalFinal",x=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;b.ShaderStore.IncludesShadersStore[w]||(b.ShaderStore.IncludesShadersStore[w]=x);let y="openpbrBaseLayerData",z=`vec3 base_color=vec3(0.8);float base_metalness=0.0;float base_diffuse_roughness=0.0;float specular_weight=1.0;float specular_roughness=0.3;vec3 specular_color=vec3(1.0);float specular_roughness_anisotropy=0.0;float specular_ior=1.5;float alpha=1.0;vec2 geometry_tangent=vec2(1.0,0.0);
#ifdef BASE_WEIGHT
...
#endif
`;b.ShaderStore.IncludesShadersStore[y]||(b.ShaderStore.IncludesShadersStore[y]=z);let A="openpbrCoatLayerData",B=`float coat_weight=0.0;vec3 coat_color=vec3(1.0);float coat_roughness=0.0;float coat_roughness_anisotropy=0.0;float coat_ior=1.6;float coat_darkening=1.0;vec2 geometry_coat_tangent=vec2(1.0,0.0);
#ifdef COAT_WEIGHT
...
#endif
`;b.ShaderStore.IncludesShadersStore[A]||(b.ShaderStore.IncludesShadersStore[A]=B);let C="openpbrThinFilmLayerData",D=`#ifdef THIN_FILM
...
#endif
#endif
`;b.ShaderStore.IncludesShadersStore[C]||(b.ShaderStore.IncludesShadersStore[C]=D);let E="openpbrFuzzLayerData",F=`float fuzz_weight=0.0;vec3 fuzz_color=vec3(1.0);float fuzz_roughness=0.0;
#ifdef FUZZ
#ifdef FUZZ_WEIGHT
...
#endif
#endif
`;b.ShaderStore.IncludesShadersStore[E]||(b.ShaderStore.IncludesShadersStore[E]=F),a.i(63649);let G="openpbrEnvironmentLighting",H=`#ifdef REFLECTION
#ifdef FUZZ
...
#endif
#endif
`;b.ShaderStore.IncludesShadersStore[G]||(b.ShaderStore.IncludesShadersStore[G]=H);let I="openpbrDirectLightingInit",J=`#ifdef LIGHT{X}
...
#endif
#endif
`;b.ShaderStore.IncludesShadersStore[I]||(b.ShaderStore.IncludesShadersStore[I]=J);let K="openpbrDirectLighting",L=`#ifdef LIGHT{X}
...
#endif
`;b.ShaderStore.IncludesShadersStore[K]||(b.ShaderStore.IncludesShadersStore[K]=L),a.i(430783),a.i(384701),a.i(475420),a.i(612103),a.i(353963),a.i(441052);let M="openpbrPixelShader",N=`#define OPENPBR_FRAGMENT_SHADER
...
`;b.ShaderStore.ShadersStore[M]||(b.ShaderStore.ShadersStore[M]=N),a.s(["openpbrPixelShader",0,{name:M,shader:N}],29375)}];
