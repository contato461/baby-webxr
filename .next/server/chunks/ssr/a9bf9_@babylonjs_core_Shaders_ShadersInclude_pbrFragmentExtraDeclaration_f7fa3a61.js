module.exports=[70259,129657,239820,450312,301237,881943,976729,60213,475420,612103,441052,a=>{"use strict";var b=a.i(625562);a.i(244561);let c="pbrFragmentExtraDeclaration",d=`varying vec3 vPositionW;
#if DEBUGMODE>0
...
{return diffusionProfile<1.;}`;b.ShaderStore.IncludesShadersStore[e]||(b.ShaderStore.IncludesShadersStore[e]=f),a.s([],129657);let g="pbrHelperFunctions",h=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;b.ShaderStore.IncludesShadersStore[g]||(b.ShaderStore.IncludesShadersStore[g]=h),a.s([],239820),a.i(28439);let i="pbrDirectLightingSetupFunctions",j=`struct preLightingInfo
...
#endif
`;b.ShaderStore.IncludesShadersStore[i]||(b.ShaderStore.IncludesShadersStore[i]=j),a.s([],450312);let k="pbrDirectLightingFalloffFunctions",l=`float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
...
#endif
}`;b.ShaderStore.IncludesShadersStore[k]||(b.ShaderStore.IncludesShadersStore[k]=l),a.s([],301237);let m="pbrDirectLightingFunctions",n=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{vec3 diffuse;
...
#endif
`;b.ShaderStore.IncludesShadersStore[m]||(b.ShaderStore.IncludesShadersStore[m]=n),a.s([],881943);let o="pbrIBLFunctions",p=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;b.ShaderStore.IncludesShadersStore[o]||(b.ShaderStore.IncludesShadersStore[o]=p),a.s([],976729);let q="pbrBlockNormalGeometric",r=`vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
#endif
`;b.ShaderStore.IncludesShadersStore[s]||(b.ShaderStore.IncludesShadersStore[s]=t),a.s([],475420);let u="pbrBlockPrePass",v=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;b.ShaderStore.IncludesShadersStore[u]||(b.ShaderStore.IncludesShadersStore[u]=v),a.s([],612103);let w="pbrDebug",x=`#if DEBUGMODE>0
...
#endif
`;b.ShaderStore.IncludesShadersStore[w]||(b.ShaderStore.IncludesShadersStore[w]=x),a.s([],441052)}];
