...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[a]||(r.ShaderStore.IncludesShadersStoreWGSL[a]=i),e.i(204560),e.i(160334),e.i(847193),e.i(956235),e.i(864500),e.i(690617),e.i(902241),e.i(11623),e.i(627662),e.i(970070),e.i(285633),e.i(421743),e.i(326857),e.i(945595),e.i(136730),e.i(840951),e.i(48424);let t="openpbrNormalMapFragmentMainFunctions",n=`#if defined(GEOMETRY_NORMAL) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[t]||(r.ShaderStore.IncludesShadersStoreWGSL[t]=n);let o="openpbrNormalMapFragmentFunctions",f=`#if defined(GEOMETRY_NORMAL)
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[o]||(r.ShaderStore.IncludesShadersStoreWGSL[o]=f),e.i(379799);let l="openpbrDielectricReflectance",c=`struct ReflectanceParams
{F0: f32,
F90: f32,
coloredF0: vec3f,
coloredF90: vec3f,};
...
`;r.ShaderStore.IncludesShadersStoreWGSL[l]||(r.ShaderStore.IncludesShadersStoreWGSL[l]=c);let s="openpbrConductorReflectance",m=`#define pbr_inline
...
#endif
outParams.F0=1.0f;outParams.F90=1.0f;return outParams;}`;r.ShaderStore.IncludesShadersStoreWGSL[s]||(r.ShaderStore.IncludesShadersStoreWGSL[s]=m);let d="openpbrBlockAmbientOcclusion",u=`struct ambientOcclusionOutParams
...
`;r.ShaderStore.IncludesShadersStoreWGSL[d]||(r.ShaderStore.IncludesShadersStoreWGSL[d]=u);let p="openpbrGeometryInfo",_=`struct geometryInfoOutParams
{NdotV: f32,
NdotVUnclamped: f32,
...
`;r.ShaderStore.IncludesShadersStoreWGSL[p]||(r.ShaderStore.IncludesShadersStoreWGSL[p]=_);let g="openpbrIblFunctions",v=`#ifdef REFLECTION
fn sampleIrradiance(
surfaceNormal: vec3f
...
#endif
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[E]||(r.ShaderStore.IncludesShadersStoreWGSL[E]=h);let N="openpbrBaseLayerData",R=`var base_color=vec3f(0.8);var base_metalness: f32=0.0;var base_diffuse_roughness: f32=0.0;var specular_weight: f32=1.0;var specular_roughness: f32=0.3;var specular_color: vec3f=vec3f(1.0);var specular_roughness_anisotropy: f32=0.0;var specular_ior: f32=1.5;var alpha: f32=1.0;var geometry_tangent: vec2f=vec2f(1.0,0.0);
#ifdef BASE_WEIGHT
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[N]||(r.ShaderStore.IncludesShadersStoreWGSL[N]=R);let L="openpbrCoatLayerData",A=`var coat_weight: f32=0.0f;var coat_color: vec3f=vec3f(1.0f);var coat_roughness: f32=0.0f;var coat_roughness_anisotropy: f32=0.0f;var coat_ior: f32=1.6f;var coat_darkening: f32=1.0f;var geometry_coat_tangent: vec2f=vec2f(1.0f,0.0f);
#ifdef COAT_WEIGHT
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[L]||(r.ShaderStore.IncludesShadersStoreWGSL[L]=A);let F="openpbrThinFilmLayerData",T=`#ifdef THIN_FILM
...
#endif
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[F]||(r.ShaderStore.IncludesShadersStoreWGSL[F]=T);let O="openpbrFuzzLayerData",b=`var fuzz_weight: f32=0.0f;var fuzz_color: vec3f=vec3f(1.0);var fuzz_roughness: f32=0.0f;
#ifdef FUZZ
#ifdef FUZZ_WEIGHT
...
#endif
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[O]||(r.ShaderStore.IncludesShadersStoreWGSL[O]=b),e.i(116507);let C="openpbrEnvironmentLighting",M=`#ifdef REFLECTION
#ifdef FUZZ
...
#endif
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[C]||(r.ShaderStore.IncludesShadersStoreWGSL[C]=M);let D="openpbrDirectLightingInit",x=`#ifdef LIGHT{X}
...
#endif
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[D]||(r.ShaderStore.IncludesShadersStoreWGSL[D]=x);let G="openpbrDirectLighting",P=`#ifdef LIGHT{X}
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[G]||(r.ShaderStore.IncludesShadersStoreWGSL[G]=P),e.i(282742),e.i(775587),e.i(88558),e.i(86826),e.i(170177),e.i(291032);let z="openpbrPixelShader",y=`#define OPENPBR_FRAGMENT_SHADER
...
`;r.ShaderStore.ShadersStoreWGSL[z]||(r.ShaderStore.ShadersStoreWGSL[z]=y),e.s(["openpbrPixelShaderWGSL",0,{name:z,shader:y}],356046)}]);