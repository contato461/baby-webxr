...
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[u]||(t.ShaderStore.IncludesShadersStoreWGSL[u]=v),e.s([],566364);let E="pbrDirectLightingFunctions",p=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{diffuse: vec3f,
#ifdef SS_TRANSLUCENCY
...
return result;}
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[E]||(t.ShaderStore.IncludesShadersStoreWGSL[E]=p),e.s([],840951);let h="pbrIBLFunctions",g=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[h]||(t.ShaderStore.IncludesShadersStoreWGSL[h]=g),e.s([],48424);let m="pbrBlockNormalGeometric",L=`var viewDirectionW: vec3f=normalize(scene.vEyePosition.xyz-input.vPositionW);
#ifdef NORMAL
...
#endif
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[N]||(t.ShaderStore.IncludesShadersStoreWGSL[N]=D),e.s([],86826);let A="pbrDebug",O=`#if DEBUGMODE>0
...
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[A]||(t.ShaderStore.IncludesShadersStoreWGSL[A]=O),e.s([],291032)}]);