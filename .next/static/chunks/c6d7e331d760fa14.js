(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,920385,e=>{"use strict";var t=e.i(47662);let r="lightFragment",i=`#ifdef LIGHT{X}
...
#endif
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=i),e.s(["lightFragmentWGSL",0,{name:r,shader:i}])},379799,e=>{"use strict";var t=e.i(47662);let r="reflectionFunction",i=`fn computeFixedEquirectangularCoords(worldPos: vec4f,worldNormal: vec3f,direction: vec3f)->vec3f
...
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=i),e.s(["reflectionFunctionWGSL",0,{name:r,shader:i}])},956235,e=>{"use strict";var t=e.i(47662);let r="fogFragmentDeclaration",i=`#ifdef FOG
...
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=i),e.s(["fogFragmentDeclarationWGSL",0,{name:r,shader:i}])},775587,e=>{"use strict";var t=e.i(47662);let r="fogFragment",i=`#ifdef FOG
...
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=i),e.s([])},160334,e=>{"use strict";var t=e.i(47662);let r="clipPlaneFragmentDeclaration",i=`#ifdef CLIPPLANE
...
{discard;}
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=i),e.s(["clipPlaneFragmentWGSL",0,{name:r,shader:i}])},282742,e=>{"use strict";var t=e.i(47662);let r="logDepthFragment",i=`#ifdef LOGARITHMICDEPTH
fragmentOutputs.fragDepth=log2(fragmentInputs.vFragmentDepth)*uniforms.logarithmicDepthConstant*0.5;
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=i),e.s([])},204560,e=>{"use strict";var t=e.i(47662);let r="imageProcessingDeclaration",i=`#ifdef EXPOSURE
...
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=i),e.s(["imageProcessingDeclarationWGSL",0,{name:r,shader:i}])},627662,e=>{"use strict";var t=e.i(47662);let r="imageProcessingFunctions",i=`#if TONEMAPPING==3
...
return vec4f(rgb,result.a);}`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=i),e.s(["imageProcessingFunctionsWGSL",0,{name:r,shader:i}])},970070,e=>{"use strict";var t=e.i(47662);let r="shadowsFragmentFunctions",i=`#ifdef SHADOWS
#ifndef SHADOWFLOAT
...
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=i),e.s(["shadowsFragmentFunctionsWGSL",0,{name:r,shader:i}])},970619,e=>{"use strict";var t=e.i(47662);let r="lightUboDeclaration",i=`#ifdef LIGHT{X}
struct Light{X}
{vLightData: vec4f,
vLightDiffuse: vec4f,
...
#endif
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=i),e.s(["lightUboDeclarationWGSL",0,{name:r,shader:i}])},898135,e=>{"use strict";var t=e.i(47662);let r="clusteredLightingFunctions",i=`struct ClusteredLight {vLightData: vec4f,
vLightDiffuse: vec4f,
vLightSpecular: vec4f,
vLightDirection: vec4f,
vLightFalloff: vec4f,}
...
`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=i),e.s([])},197412,e=>{"use strict";var t=e.i(47662);let r="ltcHelperFunctions",i=`fn LTCUv(N: vec3f,V: vec3f,roughness: f32)->vec2f {var LUTSIZE: f32=64.0;var LUTSCALE: f32=( LUTSIZE-1.0 )/LUTSIZE;var LUTBIAS:f32=0.5/LUTSIZE;var dotNV:f32=saturate( dot( N,V ) );var uv:vec2f=vec2f( roughness,sqrt( 1.0-dotNV ) );uv=uv*LUTSCALE+LUTBIAS;return uv;}
...
vec3f( 0,1,0 ),
vec3f( 0,0,1 )
);result.Diffuse+=LTCEvaluate( normal,viewDir,position,mInvEmpty,rectCoords0,rectCoords1,rectCoords2,rectCoords3 );return result;}`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=i),e.s([])}]);