...
class NodeMaterialBlock {
     ...
     */ registerInput(name, type, isOptional = false, target, point) {
        point = point ?? new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babylonjs$2f$core$2f$Materials$2f$Node$2f$nodeMaterialBlockConnectionPoint$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NodeMaterialConnectionPoint"](name, this, 0 /* NodeMaterialConnectionPointDirection.Input */ );
        point.type = type;
     ...
     */ registerOutput(name, type, target, point) {
        point = point ?? new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babylonjs$2f$core$2f$Materials$2f$Node$2f$nodeMaterialBlockConnectionPoint$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NodeMaterialConnectionPoint"](name, this, 1 /* NodeMaterialConnectionPointDirection.Output */ );
        point.type = type;
        if (target) {
            point.target = target;
        }
     ...
     */ build(state, activeBlocks) {
        ...
        if (state.sharedData.verbose) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babylonjs$2f$core$2f$Misc$2f$logger$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Logger"].Log(`${state.target === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babylonjs$2f$core$2f$Materials$2f$Node$2f$Enums$2f$nodeMaterialBlockTargets$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NodeMaterialBlockTargets"].Vertex ? "Vertex shader" : "Fragment shader"}: Building ${this.name} [${this.getClassName()}]`);
        }
...
class NodeMaterialDefinesBase extends (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babylonjs$2f$core$2f$Materials$2f$uv$2e$defines$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UVDefinesMixin"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babylonjs$2f$core$2f$Materials$2f$materialDefines$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MaterialDefines"]) {
}
class NodeMaterialDefines extends (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babylonjs$2f$core$2f$Materials$2f$imageProcessingConfiguration$2e$defines$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ImageProcessingDefinesMixin"])(NodeMaterialDefinesBase) {
    /**
...
class NodeMaterialBase extends (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babylonjs$2f$core$2f$Materials$2f$imageProcessing$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ImageProcessingMixin"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babylonjs$2f$core$2f$Materials$2f$pushMaterial$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PushMaterial"]) {
}
class NodeMaterial extends NodeMaterialBase {
    ...
    _prepareDefinesForAttributes(mesh, defines) {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babylonjs$2f$core$2f$Materials$2f$materialHelper$2e$functions$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["PrepareDefinesForPrePass"])(this.getScene(), defines, !oit);
    ...
    _processDefines(defines, mesh, useInstances = false, subMesh) {
        ...
        // Global defines
        const scene = this.getScene();
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babylonjs$2f$core$2f$Materials$2f$materialHelper$2e$functions$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["PrepareDefinesForCamera"])(scene, defines)) {
     ...
     */ async _getProcessedFragmentAsync() {
        ...
        if (this.mode === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babylonjs$2f$core$2f$Materials$2f$Node$2f$Enums$2f$nodeMaterialModes$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NodeMaterialModes"].SFE) {
            processingDefines += `#define ${__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babylonjs$2f$core$2f$Materials$2f$Node$2f$Blocks$2f$Fragment$2f$smartFilterFragmentOutputBlock$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SfeModeDefine"]}\n`;
        }
     ...
     */ generateCode() {
        ...
        codeString += `nodeMaterial.mode = BABYLON.NodeMaterialModes.${__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babylonjs$2f$core$2f$Materials$2f$Node$2f$Enums$2f$nodeMaterialModes$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NodeMaterialModes"][this.mode]};\n`;
     ...
     */ parseSerializedObject(source, rootUrl = "", merge = false, urlRewriter) {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babylonjs$2f$core$2f$Misc$2f$decorators$2e$serialization$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SerializationHelper"].ParseProperties(source, this, this.getScene(), rootUrl);
        this.id = id;
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babylonjs$2f$core$2f$Materials$2f$material$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Material"].ParseAlphaMode(source, this);
        if (!merge) {
            this._mode = source.mode ?? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babylonjs$2f$core$2f$Materials$2f$Node$2f$Enums$2f$nodeMaterialModes$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NodeMaterialModes"].Material;
        }
    }
    /**
     * Clear the current graph and load a new one from a serialization object
...
/** Define the Url to load node editor script */ NodeMaterial.EditorURL = `${__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babylonjs$2f$core$2f$Misc$2f$tools$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Tools"]._DefaultCdnUrl}/v${__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babylonjs$2f$core$2f$Engines$2f$abstractEngine$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AbstractEngine"].Version}/nodeEditor/babylon.nodeEditor.js`;
...
__turbopack_context__.s([]);
/* eslint-disable @typescript-eslint/no-restricted-imports */ var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babylonjs$2f$core$2f$Materials$2f$Node$2f$Enums$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/@babylonjs/core/Materials/Node/Enums/index.js [app-client] (ecmascript) <locals>");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babylonjs$2f$core$2f$Materials$2f$Node$2f$Blocks$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/@babylonjs/core/Materials/Node/Blocks/index.js [app-client] (ecmascript) <locals>");
...
//# sourceMappingURL=node_modules_%40babylonjs_core_Materials_Node_6d607a5a._.js.map